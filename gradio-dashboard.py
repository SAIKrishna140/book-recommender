...
def retrieve_sematic_recommendations(query:str,
                                     category:str=None,
                                     tone:str=None,
...
with gr.Blocks(theme=gr.themes.Glass()) as dashboard:
    ...
    with gr.Row():
        user_query=gr.Textbox(label="Please enter a description:",
                              placeholder="e.g., A story about World War")
        category_dropdown=gr.Dropdown(choices=categories,label="Please select a category:",
                                      value="All")
